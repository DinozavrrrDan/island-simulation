...
import com.dinozavrrr.annotations.Parent;
import com.dinozavrrr.annotations.Property;
...
public class IslandObjectsFactory {
    ...
    public void initIslandObjectsMap() {
        ...
        for (Class<?> aClass : allClassesFromMtPackage) {
            com.dinozavrrr.annotations.IslandObject islandObjectAnnotation = getIslandObject(aClass);
    ...
    private static com.dinozavrrr.annotations.IslandObject getIslandObject(Class<?> aClass) {
        return aClass.getAnnotation(com.dinozavrrr.annotations.IslandObject.class);
    }
